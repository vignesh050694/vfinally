...
class FinallyControls extends StatefulWidget {
  const FinallyControls({
  ...
  State<StatefulWidget> createState() {
    return _FinallyControlsState();
  }
}

class _FinallyControlsState extends State<FinallyControls> {
  ...
  AnimatedOpacity _buildCenterArea() {
    return AnimatedOpacity(
      opacity: _hideStuff ? 0.0 : 1.0,
      duration: Duration(milliseconds: 300),
      child: Row(
        children: <Widget>[
          _buildSkipBack(Colors.white, 80.0),
          Expanded(
            child: Container(
              child: GestureDetector(
                onTap: _latestValue != null && _latestValue.isPlaying
                ...
                child: _buildPlayPause(controller, Colors.white, 80.0),
              ),
            ),
          ),
          _buildSkipForward(Colors.white, 80.0)
        ],
      ),
    );
  }
  ...
  AnimatedOpacity _buildQuality(){
    return AnimatedOpacity(
      ...
      child: DropdownButton<String>(
        ...
        items: <String>['Auto', '560', '720', '1080', 'Free']
  ...
  Widget _buildTopBar(
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          _buildText('Why Singles are always Singles'),
  ...
  AnimatedOpacity _buildText(String text) {
    return AnimatedOpacity(
      opacity: _hideStuff ? 0.0 : 1.0,
      duration: Duration(milliseconds: 300),
      child: Text(
  ...
  AnimatedOpacity _buildSubTitle() {
    return AnimatedOpacity(
      opacity: _hideStuff ? 0.0 : 1.0,
      duration: Duration(milliseconds: 300),
      child: Padding(
